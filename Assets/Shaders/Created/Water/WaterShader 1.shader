Shader "Environment/Water/WaterShader1"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 packedNormal = (tex2D(_NormalMap, i.uv));
                ...
                float3 worldNormal =( mul(packedNormal, (float3x3)unity_WorldToObject));
                ...
                specular = (saturate(pow(specular, _SpecularExpo))) + 0.2;
